...
{
    public class TestNavigationService : INavigationService, IPageAware
    {
		...
		public TestNavigationService(IUnityContainer container, IApplicationProvider applicationProvider, ILoggerFacade logger)
        {
		...
		protected virtual void ApplyPageBehaviors(Page page)
		{
			...
			{
				page.Behaviors.Add(new Prism.Behaviors.NavigationPageSystemGoBackBehavior());
			}
			else if (page is TabbedPage)
			{
				page.Behaviors.Add(new Prism.Behaviors.TabbedPageActiveAwareBehavior());
			}
			else if (page is CarouselPage)
			{
                page.Behaviors.Add(new Prism.Behaviors.CarouselPageActiveAwareBehavior());
			}
		}
