...
namespace SamplesCommon
{
    public sealed class CompositionImage : Control
    {
        ...
        public static readonly DependencyProperty SourceProperty =
            DependencyProperty.Register("Source", typeof(Uri), typeof(CompositionImage), new PropertyMetadata(null, OnSourcePropertyChanged));
        ...
        private async void LoadSurface()
        {
            ...
            try
            {
                ...
                CompositionDrawingSurface surface = await SurfaceLoader.LoadFromUri(Source, Size.Empty, _loadEffectDelegate);
